...
INSERT INTO watchlist_nifty_500(`company_name`,`industry`,`symbol`,series,isin)
	VALUES('3M India Ltd.','SERVICES','3MINDIA','EQ','INE470A01017'),
		...
		('Aban Offshore Ltd.','ENERGY','ABAN','EQ','INE421A01028'),
		('Adani Enterprises Ltd.','SERVICES','ADANIENT','EQ','INE423A01024'),
		...
		('Ahluwalia Contracts (India) Ltd.','CONSTRUCTION','AHLUCONT','EQ','INE758C01029'),
		...
		('Apar Industries Ltd.','INDUSTRIAL MANUFACTURING','APARINDS','EQ','INE372A01015'),
		...
		('Arvind Ltd.','TEXTILES','ARVIND','EQ','INE034A01011'),
		...
		('Avanti Feeds Ltd.','CONSUMER GOODS','AVANTIFEED','EQ','INE871C01020'),
		...
		('BF Utilities Ltd.','CONSTRUCTION','BFUTILITIE','EQ','INE243D01012'),
		('BGR Energy Systems Ltd','CONSTRUCTION','BGRENERGY','EQ','INE661I01014'),
		('BSE Ltd.','FINANCIAL SERVICES','BSE','EQ','INE118H01025'),
		('Bajaj Auto Ltd.','AUTOMOBILE','BAJAJ-AUTO','EQ','INE917I01010'),
		('Bajaj Corp Ltd.','CONSUMER GOODS','BAJAJCORP','EQ','INE933K01021'),
		...
		('Bajaj Hindusthan Sugar Ltd.','CONSUMER GOODS','BAJAJHIND','EQ','INE306A01021'),
		...
		('Ballarpur Industries Ltd.','PAPER','BALLARPUR','EQ','INE294A01037'),
		...
		('Bharat Financial Inclusion Ltd.','FINANCIAL SERVICES','BHARATFIN','EQ','INE180K01011'),
		...
		('Bhushan Steel Ltd.','METALS','BHUSANSTL','EQ','INE824B01021'),
		...
		('Bombay Rayon Fashions Ltd.','TEXTILES','BRFL','EQ','INE589G01011'),
		...
		('Capital First Ltd.','FINANCIAL SERVICES','CAPF','EQ','INE688I01017'),
		...
		('Century Textile & Industries Ltd.','CEMENT & CEMENT PRODUCTS','CENTURYTEX','EQ','INE055A01016'),
		...
		('D B Realty Ltd.','CONSTRUCTION','DBREALTY','EQ','INE879I01012'),
		...
		('Dalmia Bharat Ltd.','CEMENT & CEMENT PRODUCTS','DALMIABHA','EQ','INE439L01019'),
		...
		('Den Networks Ltd.','MEDIA & ENTERTAINMENT','DEN','EQ','INE947J01015'),
		('Dena Bank','FINANCIAL SERVICES','DENABANK','EQ','INE077A01010'),
		('Dewan Housing Finance Corporation Ltd.','FINANCIAL SERVICES','DHFL','EQ','INE202B01012'),
		('Dhanuka Agritech Ltd.','FERTILISERS & PESTICIDES','DHANUKA','EQ','INE435G01025'),
		('Dilip Buildcon Ltd.','CONSTRUCTION','DBL','EQ','INE917M01012'),
		('Dish TV India Ltd.','MEDIA & ENTERTAINMENT','DISHTV','EQ','INE836F01026'),
		('Divis Laboratories Ltd.','PHARMA','DIVISLAB','EQ','INE361B01024'),
		('Dr. Lal Path Labs Ltd.','HEALTHCARE SERVICES','LALPATHLAB','EQ','INE600L01024'),
		('Dr. Reddys Laboratories Ltd.','PHARMA','DRREDDY','EQ','INE089A01023'),
		('Dredging Corporation of India Ltd.','SERVICES','DREDGECORP','EQ','INE506A01018'),
		...
		('Eros Intl Media Ltd.','MEDIA & ENTERTAINMENT','EROSMEDIA','EQ','INE416L01017'),
		('Escorts Ltd.','AUTOMOBILE','ESCORTS','EQ','INE042A01014'),
		('Essel Propack Ltd.','INDUSTRIAL MANUFACTURING','ESSELPACK','EQ','INE255A01020'),
		('Eveready Industries India Ltd.','CONSUMER GOODS','EVEREADY','EQ','INE128A01029'),
		...
		('GVK Power & Infrastructures Ltd.','CONSTRUCTION','GVKPIL','BE','INE251H01024'),
		('Gateway Distriparks Ltd.','SERVICES','GDL','EQ','INE852F01015'),
		('Gati Ltd.','SERVICES','GATI','EQ','INE152B01027'),
		...
		('Greenply Industries Ltd.','CONSUMER GOODS','GREENPLY','EQ','INE461C01038'),
		...
		('Gujarat Fluorochemicals Ltd.','INDUSTRIAL MANUFACTURING','GUJFLUORO','EQ','INE538A01037'),
		('Gujarat Gas Ltd.','ENERGY','GUJGASLTD','EQ','INE844O01022'),
		...
		('HCL Infosystems Ltd.','IT','HCL-INSYS','EQ','INE236A01020'),
		('HCL Technologies Ltd.','IT','HCLTECH','EQ','INE860A01027'),
		('HDFC Bank Ltd.','FINANCIAL SERVICES','HDFCBANK','EQ','INE040A01026'),
		('HSIL Ltd.','CONSUMER GOODS','HSIL','EQ','INE415A01038'),
		('HT Media Ltd.','MEDIA & ENTERTAINMENT','HTMEDIA','EQ','INE501G01024'),
		...
		('Hindustan Construction Co. Ltd.','CONSTRUCTION','HCC','EQ','INE549A01026'),
		...
		('Housing Development and Infrastructure Ltd.','CONSTRUCTION','HDIL','EQ','INE191I01012'),
		('I T C Ltd.','CONSUMER GOODS','ITC','EQ','INE154A01025'),
		...
		('IDFC Bank Ltd.','FINANCIAL SERVICES','IDFCBANK','EQ','INE092T01019'),
		...
		('IL&FS Transportation Networks Ltd.','CONSTRUCTION','IL&FSTRANS','EQ','INE975G01012'),
		...
		('Idea Cellular Ltd.','TELECOM','IDEA','EQ','INE669E01016'),
		('Igarashi Motors India Ltd.','AUTOMOBILE','IGARASHI','EQ','INE188B01013'),
		...
		('Indo Count Industries Ltd.','TEXTILES','ICIL','EQ','INE483B01026'),
		...
		('Infibeam Incorporation Ltd.','IT','INFIBEAM','EQ','INE483S01020'),
		('Info Edge (India) Ltd.','IT','NAUKRI','EQ','INE663F01024'),
		('Infosys Ltd.','IT','INFY','EQ','INE009A01021'),
		('Ingersoll Rand (India) Ltd.','INDUSTRIAL MANUFACTURING','INGERRAND','EQ','INE177A01018'),
		...
		('J.Kumar Infraprojects Ltd.','CONSTRUCTION','JKIL','EQ','INE576I01022'),
		('JBF Industries Ltd.','TEXTILES','JBFIND','EQ','INE187A01017'),
		...
		('Jaiprakash Power Ventures Ltd.','ENERGY','JPPOWER','EQ','INE351F01018'),
		...
		('Jindal Poly Films Ltd.','INDUSTRIAL MANUFACTURING','JINDALPOLY','EQ','INE197D01010'),
		...
		('Johnson Controls - Hitachi Air Conditioning India Ltd.','CONSUMER GOODS','JCHAC','EQ','INE782A01015'),
		...
		('KPIT Technologies Ltd.','IT','KPIT','EQ','INE836A01035'),
		...
		('Kesoram Industries Ltd.','CEMENT & CEMENT PRODUCTS','KESORAMIND','EQ','INE087A01019'),
		('Kitex Garments Ltd.','TEXTILES','KITEX','EQ','INE602G01020'),
		...
		('Kwality Ltd.','CONSUMER GOODS','KWALITY','EQ','INE775B01025'),
		...
		('Mahanagar Telephone Nigam Ltd.','TELECOM','MTNL','EQ','INE153A01019'),
		...
		('Manpasand Beverages Ltd.','CONSUMER GOODS','MANPASAND','EQ','INE122R01018'),
		('Marico Ltd.','CONSUMER GOODS','MARICO','EQ','INE196A01026'),
		('Marksans Pharma Ltd.','PHARMA','MARKSANS','EQ','INE750C01026'),
		...
		('McLeod Russel India Ltd.','CONSUMER GOODS','MCLEODRUSS','EQ','INE942G01012'),
		('Merck Ltd.','PHARMA','MERCK','EQ','INE199A01012'),
		...
		('NBCC (India) Ltd.','CONSTRUCTION','NBCC','EQ','INE095N01023'),
		...
		('Navkar Corporation Ltd.','SERVICES','NAVKARCORP','EQ','INE278M01019'),
		('Navneet Education Ltd.','MEDIA & ENTERTAINMENT','NAVNETEDUL','EQ','INE060A01024'),
		...
		('PTC India Fin Serv Ltd.','FINANCIAL SERVICES','PFS','EQ','INE560K01014'),
		...
		('Polaris Consulting & Services Ltd.','IT','POLARIS','EQ','INE763A01023'),
		...
		('Prism Cement Ltd.','CEMENT & CEMENT PRODUCTS','PRISMCEM','EQ','INE010A01011'),
		...
		('Ramco Systems Ltd.','IT','RAMCOSYS','EQ','INE246B01019'),
		...
		('RattanIndia Power Ltd.','ENERGY','RTNPOWER','EQ','INE399K01017'),
		...
		('Reliance Naval and Engineering Ltd.','INDUSTRIAL MANUFACTURING','RNAVAL','EQ','INE542F01012'),
		('Reliance Power Ltd.','ENERGY','RPOWER','EQ','INE614G01033'),
		('Religare Enterprises Ltd.','FINANCIAL SERVICES','RELIGARE','EQ','INE621H01010'),
		...
		('SML Isuzu Ltd.','AUTOMOBILE','SMLISUZU','EQ','INE294B01019'),
		...
		('Schneider Electric Infrastructure Ltd.','INDUSTRIAL MANUFACTURING','SCHNEIDER','EQ','INE839M01018'),
		...
		('Snowman Logistics Ltd.','SERVICES','SNOWMAN','EQ','INE734N01019'),
		('Sobha Ltd.','CONSTRUCTION','SOBHA','EQ','INE671H01015'),
		('Solar Industries India Ltd.','CHEMICALS','SOLARINDS','EQ','INE343H01029'),
		('Somany Ceramics Ltd.','CONSTRUCTION','SOMANYCERA','EQ','INE355A01028'),
		...
		('Strides Shasun Ltd.','PHARMA','STAR','EQ','INE939A01011'),
		...
		('Supreme Petrochem Ltd.','CHEMICALS','SUPPETRO','EQ','INE663A01017'),
		...
		('TVS Srichakra Ltd.','AUTOMOBILE','TVSSRICHAK','EQ','INE421C01016'),
		...
		('Tata Communications Ltd.','TELECOM','TATACOMM','EQ','INE151A01013'),
		...
		('Tata Sponge Iron Ltd.','METALS','TATASPONGE','EQ','INE674A01014'),
		('Tata Steel Ltd.','METALS','TATASTEEL','EQ','INE081A01012'),
		('Tech Mahindra Ltd.','IT','TECHM','EQ','INE669C01036'),
		('Techno Elt & Eng Co. Ltd.','CONSTRUCTION','TECHNO','EQ','INE286K01024'),
		('Texmaco Rail & Eng. Ltd.','INDUSTRIAL MANUFACTURING','TEXRAIL','EQ','INE621L01012'),
		...
		('Vesuvius India Ltd.','INDUSTRIAL MANUFACTURING','VESUVIUS','EQ','INE386A01015'),
		('Videocon Industries Ltd.','CONSUMER GOODS','VIDEOIND','EQ','INE703A01011'),
		('Vijaya Bank','FINANCIAL SERVICES','VIJAYABANK','EQ','INE705A01016'),
		('Vinati Organics Ltd.','CHEMICALS','VINATIORGA','EQ','INE410B01029'),
		('Voltas Ltd.','CONSTRUCTION','VOLTAS','EQ','INE226A01021'),
		...
		('Zee Learn Ltd.','MEDIA & ENTERTAINMENT','ZEELEARN','EQ','INE565L01011'),
		('Zensar Technolgies Ltd.','IT','ZENSARTECH','EQ','INE520A01019'),
